...
CATALOG: dict[str, McUniform] = {
    ...
    for u in [
        ...
        McUniform("wetness", "float", "Smoothed rain strength.", auto=True,
                  provider="wetness"),
        McUniform("eyeBrightness", "ivec2",
                  "Light at the camera as (block, sky), each 0..240.",
                  auto=True, provider="eye_brightness"),
        McUniform("eyeBrightnessSmooth", "ivec2",
                  "eyeBrightness, eased over time.", auto=True,
                  provider="eye_brightness_smooth"),
        McUniform("isEyeInWater", "int",
                  "0 in air, 1 submerged in water, 2 in lava.", auto=True,
                  provider="eye_in_water"),
